...
<body>
    ...
    if ($pageTitle !== 'Acesso')
    {
        ...
        <h5 id='loggedUser'>
            Olá, {$_SESSION['loggedUser']} | <a href='./?desconectar'>Desconectar</a>
        </h5>
        ";
    }
